                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="list-group">
                                                                <a href="ventas_rpt.php?opcion=1" class="list-group-item">Por Fechas</a>
                                                                ...
                                                                <a href="ventas_rpt.php?opcion=5" class="list-group-item">Por Sucursal</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php break;
                                                                case 2: //por clientes
                                                                    $clientes = consultas::get_datos("select cli_cod,cli_ci,(cli_nombre||' '||cli_apellido) as nombres from clientes where cli_cod in(select cli_cod from ventas)"); ?>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-lg-2">Clientes:</label>
                                                                ...
                                                                <?php break;
                                                                case 4: //por empleado
                                                                    $empleados = consultas::get_datos("select emp_cod,(emp_nombre||' '||emp_apellido) as nombres from empleado where emp_cod in(select emp_cod from ventas)"); ?>
                                                                    <div class="form-group">
                                                                ...
                                                                <?php break;
                                                                case 5: //por sucursal
                                                                    $sucursales = consultas::get_datos("select * from sucursal where id_sucursal in(select id_sucursal from ventas)"); ?>
                                                                    <div class="form-group">
