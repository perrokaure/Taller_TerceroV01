                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <a href="persona_index.php" class="btn-primary btn-sm" data-title="Volver" rel="tooltip">
                            ...
                            <form action="persona_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-2 col-md-2 col-sm-2">persona:</label>
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-5">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn btn-flat">
                                                    <a class="btn btn-primary" data-title="Agregar al empleado" rel="tooltip" data-placement="top" data-toggle="modal" data-target="#registrar2">
                                                        <i class="fa fa-plus"></i>
                                                    </a>
                                                </span>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-5">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn btn-flat">
                                                    <a class="btn btn-primary" data-title="Agregar el grupo" rel="tooltip" data-placement="top" data-toggle="modal" data-target="#registrar2">
                                                        <i class="fa fa-plus"></i>
                                                    </a>
                                                </span>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-5">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn btn-flat">
                                                    <a class="btn btn-primary" data-title="Agregar el sucursal" rel="tooltip" data-placement="top" data-toggle="modal" data-target="#registrar2">
                                                        <i class="fa fa-plus"></i>
                                                    </a>
                                                </span>
                                            </div>
