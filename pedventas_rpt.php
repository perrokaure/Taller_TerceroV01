                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Reporte de Pedido de Ventas</h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        ?>
                                        <form action="pedventas_print.php" method="get" accept-charset="utf-8" class="form-horizontal" target="print">
                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="list-group">
                                                                <a href="pedventas_rpt.php?opcion=1" class="list-group-item">Por Fechas</a>
                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php break;
                                                                case 2: //por clientes
                                                                    $clientes = consultas::get_datos("select cli_cod,cli_ci,(cli_nombre||' '||cli_apellido) as nombres from clientes where cli_cod in(select cli_cod from pedido_cabventa)"); ?>
