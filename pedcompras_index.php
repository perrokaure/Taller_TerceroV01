                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <a href="pedcompras_add.php" class="btn btn-primary btn-sm pull-right" data-title='Agregar' rel='tooltip' data-placement='top'><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td data-title='Acciones' class="text-center">
                                                                    <?php if ($ped['estado'] == "PENDIENTE") { ?>
                                                                        ...
                                                                        <a onclick="anular(<?php echo "'" . $ped['ped_com'] . "_" . $ped['proveedor'] . "_" . $ped['ped_fecha'] . "'" ?>)" class="btn btn-danger btn-sm" role='button' data-title='Anular' rel='tooltip' data-placement='top' data-toggle="modal" data-target="#anular">
                                                                            <span class="glyphicon glyphicon-remove"></span>
                                                                        </a>
                                                                    <?php } ?>
                                                                    <a href="pedcompras_print.php?vped_com=<?php echo $ped['ped_com']; ?>" class="btn btn-default btn-sm" role='button' data-title='Imprimir' rel='tooltip' data-placement='top' target="print">
