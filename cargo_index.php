                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    ...
                                    <a href="cargo_print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip" target="print">
                                                        ...
                                                        <?php foreach ($cargos as $cargo) { ?>
                                                            <tr>
                                                                ...
                                                                <td data-title="Acciones" class="text-center">
                                                                    <a onclick="editar(<?php echo "'" . $cargo['car_cod'] . "_" . $cargo['car_descri'] . "'"; ?>)" class="btn btn-warning btn-sm" role="buttom" data-title="Editar" rel="tooltip" data-toggle="modal" data-target="#editar">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <a onclick="borrar(<?php echo "'" . $cargo['car_cod'] . "_" . $cargo['car_descri'] . "'"; ?>)" class="btn btn-danger btn-sm" role="buttom" data-title="Borrar" rel="tooltip" data-toggle="modal" data-target="#borrar">
