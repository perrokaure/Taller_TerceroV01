...
<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="fa fa-plus"></i> <strong>Agregar Detalle Venta</strong></h4>
</div>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4 col-md-4 col-lg-4">
                <input type="number" name="vven_cant" class="form-control" required="" value="<?php echo $detalles[0]['ped_cant']?>" min="1"/>
            </div>
        </div> 
        <div class="form-group">
            <label class="control-label col-sm-2">Precio:</label>
            <div class="col-sm-4 col-md-4 col-lg-4">
                <input type="number" name="vven_precio" class="form-control" required="" value="<?php echo $detalles[0]['ped_precio']?>" min="1"/>
            </div>
        </div>         
    </div>
