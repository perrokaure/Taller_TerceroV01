                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        $pedidos = consultas::get_datos("select * from v_pedido_cabcompra where ped_com=" . $_REQUEST['vped_com']);
                                        //var_dump($marcas);
                                        if (!empty($pedidos)) { ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <?php $detalles = consultas::get_datos("select * from v_detalle_pedcompra where ped_com=" . $pedidos[0]['ped_com']);
                                        if (!empty($detalles)) { ?>
                                            <div class="box-header">
                                                        ...
                                                        <?php foreach ($detalles as $det) { ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <a onclick="editar(<?php echo $det['ped_com']; ?>,<?php echo $det['art_cod']; ?>,<?php echo $det['dep_cod']; ?>)" class="btn btn-warning btn-sm" role='button' data-title='Editar' rel='tooltip' data-placement='top' data-toggle="modal" data-target="#editar">
                                                                        <span class="glyphicon glyphicon-edit"></span>
                                                                    </a>
                                                                    <a onclick="borrar(<?php echo "'" . $det['ped_com'] . "_" . $det['art_cod'] . "_" . $det['dep_cod'] . "_" . $det['art_descri'] . " " . $det['mar_descri'] . "'" ?>)" class="btn btn-danger btn-sm" role='button' data-title='Borrar' rel='tooltip' data-placement='top' data-toggle="modal" data-target="#borrar">
