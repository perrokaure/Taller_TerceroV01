                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        $modulos = consultas::get_datos("select * from modulos where mod_nombre ilike '%" . (isset($_REQUEST['buscar']) ? $_REQUEST['buscar'] : "") . "%'order by mod_cod");
                                        if (!empty($modulos)) { ?>
                                                        ...
                                                        <?php foreach ($modulos as $modulo) { ?>
                                                            <tr>
                                                                ...
                                                                <td data-title="Acciones" class="text-center">
                                                                    <a onclick="editar(<?php echo "'" . $modulo['mod_cod'] . "_" . $modulo['mod_nombre'] . "'"; ?>)" class="btn btn-warning btn-sm" role="buttom" data-title="Editar" rel="tooltip" data-toggle="modal" data-target="#editar">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <a onclick="borrar(<?php echo "'" . $modulo['mod_cod'] . "_" . $modulo['mod_nombre'] . "'"; ?>)" class="btn btn-danger btn-sm" role="buttom" data-title="Borrar" rel="tooltip" data-toggle="modal" data-target="#borrar">
